# Note : NSL stands for Non Scorers League.
Feature: Match Updating and Deletion for NSL league Type.
    As an admin, I need to edit or delete a previously recorded match
    so that the match history stays accurate.
    ...
    @RLQ-XX
    Scenario: Admin edits a match correctly.
        Given I am updating the '3-2' with scorers match in 'without-scorers' league
            | team | player-name       | goals |
            | home | Antoine-Griezmann | 2     |
            | away | Ruud-Gullit       | 1     |
            | home | Kylian Mbappé     | 1     |
...
Scenario: Admin deletes a match with scorers and player goal totals adjust accordingly
    Given I am deleting the '3-2' with scorers match in 'without-scorers' league
        | team | player-name       | goals |
        | home | Antoine-Griezmann | 2     |
        | away | Ruud-Gullit       | 1     |
        | home | Kylian Mbappé     | 1     |
